...
public class TestForwardController {
	...
	@RequestMapping("forward/keys/buildSystem.json")
	...
	@RequestMapping("forward/keys/extractSecretKeyOfAlice.json")
	...
	@RequestMapping("forward/keys/extractSecretKeyOfBob.json")
	...
	@RequestMapping("forward/keys/receiveSAandSB.json")		
	public @ResponseBody List<HashMap> SAandSB() {  
		System.out.println("forward/keys/receiveSAandSB.json");
     List<HashMap> listone = new ArrayList();
	...
	@RequestMapping("forward/keys/computeTA.json")
	...
	@RequestMapping("forward/keys/computeTB.json")
    ...
    @RequestMapping("forward/keys/computeK.json")
      public @ResponseBody List<HashMap> computeK(){
    	List<HashMap> listone = new ArrayList();
    	K=(pairing.pairing(SA, TB).mul(pairing.pairing(TA, SB)).mul(pairing.pairing(SA, QB)));
	...
	@RequestMapping("forward/keys/createKA.json")
