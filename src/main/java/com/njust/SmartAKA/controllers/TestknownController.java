...
@Controller
public class TestknownController {
	...
	@RequestMapping("known/keys/buildSystem.json")
	public void buildSystem(){
		System.out.println("开始known---buildSystem");
		init();
	...
	@RequestMapping("known/keys/extractSecretKeyOfAlice.json")
	...
	@RequestMapping("known/keys/extractSecretKeyOfBob.json")
	...
	@RequestMapping("known/keys/computeTA.json")
	...
	@RequestMapping("known/keys/computeTB.json")
	...
	@RequestMapping("known/keys/createKA.json")
	public @ResponseBody List<HashMap> createKA(){  
       ...
       // System.out.println("文本长度" + (byt + 128)); 
        List<HashMap> listone = new ArrayList();
  	   HashMap<String, String> newsMap = new HashMap<String, String>();
  		newsMap.put("P",SHA((KA.toString()+hA.toString())+"Alice"+"Bob", "SHA-256"));
  		//newsMap.put("content", tmp.getTitle());
  	   listone.add(newsMap);
  	    return listone;
    }  
	@RequestMapping("known/keys/createKB.json")
	 public  @ResponseBody List<HashMap> createKB() {  
       ...
       // System.out.println("文本长度" + (byt + 128));  
        List<HashMap> listone = new ArrayList();
   	   HashMap<String, String> newsMap = new HashMap<String, String>();
   		newsMap.put("P",SHA((KB.toString()+hB.toString())+"Alice"+"Bob", "SHA-256"));
   		//newsMap.put("content", tmp.getTitle());
   	   listone.add(newsMap);
   	    return listone;
    }  
